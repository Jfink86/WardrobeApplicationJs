...
namespace WardrobeApplication.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,Photo,TopType,Color,Season,Occasion")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,Photo,TopType,Color,Season,Occasion")] Top top)
        {
            if (ModelState.IsValid)
            {
