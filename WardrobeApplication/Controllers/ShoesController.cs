...
namespace WardrobeApplication.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoesID,ShoesName,Photo,ShoeType,Color,Season,Occasion")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoesID,ShoesName,Photo,ShoeType,Color,Season,Occasion")] Sho sho)
        {
            if (ModelState.IsValid)
            {
