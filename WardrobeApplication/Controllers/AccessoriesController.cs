...
namespace WardrobeApplication.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,AccessoryName,Photo,AccessoryType,Color,Season,Occasion")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,AccessoryName,Photo,AccessoryType,Color,Season,Occasion")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
