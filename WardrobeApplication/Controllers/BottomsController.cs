...
namespace WardrobeApplication.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,BottomName,Photo,BottomType,Color,Season,Occasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,BottomName,Photo,BottomType,Color,Season,Occasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
